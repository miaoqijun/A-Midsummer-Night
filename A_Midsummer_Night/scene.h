...
class Scene {
private:
    const char* vs_path = "model_vs.glsl", *fs_path = "model_fs.glsl";
    ...
    PointLight point_lights[POINT_LIGHT_NUM] = {
        glm::vec3(-2.4f, 2.0f, 0.0f), glm::vec3(0.1f, 0.1f, 0.1f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f),
        1.0f, 0.09f, 0.032f,
        glm::vec3(-2.9f, 2.0f, -1.0f), glm::vec3(0.1f, 0.1f, 0.1f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f),
        1.0f, 0.09f, 0.032f,
        glm::vec3(-2.9f, 2.0f, 1.0f), glm::vec3(0.1f, 0.1f, 0.1f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f),
        1.0f, 0.09f, 0.032f
    };
